...
def estado_vuelo():
    ...
    if request.method == 'POST':
        ...
        if tipo == 'pnr' and valor:
            criterio = f"PNR: {valor}"
            reservas = (Reserva.query
                        .filter_by(codigo_pnr=valor)
                        .all())

        elif tipo == 'dni' and valor:
        ...
        elif tipo == 'vuelo' and valor:
            criterio = f"N° de vuelo: {valor}"
            reservas = (Reserva.query
                        .join(Vuelo)
                        .filter(Vuelo.numero_vuelo == valor)
                        .all())
